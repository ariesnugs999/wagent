...
class MY_Controller extends CI_Controller
{
    public function __construct()
    {
        ...
        if ($this->loggedIn) {
            ...
            $this->Agen                     = $this->sma->in_group('agen') ? true : null;
            $this->data['Agen']             = $this->Agen;
            $this->WPoint                   = $this->sma->in_group('wpoint') ? true : null;
            $this->data['Wpoint']           = $this->Wpoint;
