...
class Reports extends MY_Controller
{
    ...
    public function getProductsReportbulan($pdf = null, $xls = null)
    {
        $this->sma->checkPermissions('products', true);
    ...
    public function getPurchasesReportbulan($pdf = null, $xls = null)
    {
        $this->sma->checkPermissions('purchases', true);
        ...
        $year     = $this->input->get('tahun') ? $this->input->get('tahun') : null;
