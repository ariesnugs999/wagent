...
<div class="box">
    ...
    <div class="box-content">
        ...
        echo '</p></div>';
                ...
                <div class="col-xs-5">
                    <div class="col-xs-2"><i class="fa fa-3x far fa-file-alt padding010 text-muted"></i></div>
                    <div class="col-xs-10">
                ...
                <div class="btn-group btn-group-justified">
                    ...
                    <div class="btn-group">
                        <a href="<?= admin_url('sales/email/' . $inv->id) ?>" data-toggle="modal" data-target="#myModal" class="tip btn btn-primary tip" title="<?= lang('email') ?>">
                            <i class="far fa-envelope"></i> <span class="hidden-sm hidden-xs"><?= lang('email') ?></span>
                        </a>
                    </div>
                    <div class="btn-group">
                    ...
                    <div class="btn-group">
                        <a href="#" class="tip btn btn-danger bpo"
                            ...
                            data-html="true" data-placement="top"><i class="fas fa-trash-alt"></i>
