...
<head>
    ...
    <link rel="shortcut icon" href="<?= $assets ?>images/widodo3.ico"/>
    <link href="<?= $assets ?>styles/theme.css" rel="stylesheet"/>
    <link href="<?= $assets ?>styles/style.css" rel="stylesheet"/>
    <link rel="stylesheet" href="<?= $assets ?>plugins_lt3/fontawesome-free/css/all.min.css">
    ...
    <header id="header" class="navbar">
        <div class="container">
            ...
            <div class="btn-group visible-xs pull-right btn-visible-sm">
                ...
                <?php if (SHOP) {
        ?>
                <a href="<?= site_url('/') ?>" class="btn" title="<?= lang('shop') ?>">
                ...
                <?php if (POS) {
        ?>
                <a href="<?= admin_url('pos') ?>" class="btn" title="<?= lang('pos') ?>">
                    <span class="fa fa-th-large green"></span>
                </a>
                <?php
    } ?>
                <a href="<?= admin_url('calendar') ?>" class="btn" title="<?= lang('calendar') ?>">
                    <span class="fa fa-calendar"></span>
                </a>
                <a href="<?= admin_url('users/profile/' . $this->session->userdata('user_id')); ?>" class="btn" title="<?= lang('profile') ?>">
                    <span class="fa fa-user"></span>
                </a>
                <a href="<?= admin_url('logout'); ?>" class="btn" title="<?= lang('logout') ?>">
            ...
            <div class="header-nav">
                ...
                <ul class="nav navbar-nav pull-right">
                    <li class="dropdown hidden-xs"><a class="btn tip" title="<?= lang('dashboard') ?>" data-placement="bottom" href="<?= admin_url('welcome') ?>"><i class="fa fa-home"></i></a></li>
                    <?php if (SHOP) {
        ?>
                    ...
                    <ul class="nav main-menu">
                        ...
                        if ($Owner || $Admin) {
                                    ...
                                    ?>
                                        ...
                                        <li id="system_settings_warehouses">
                                            <a href="<?= admin_url('system_settings/warehouses') ?>">
                                                <i class="far fa-building"></i><span class="text"> <?= lang('warehouses'); ?></span>
                                            </a>
                                        </li>
                            ...
                            <li class="mm_shop_settings mm_api_settings">
                                <a class="dropmenu" href="#">
                                    <i class="fas fa-store"></i><span class="text"> <?= lang('front_end'); ?> </span>
                                    <span class="chevron closed"></span>
                                </a>
                                <ul>
                                    ...
                                    <li id="shop_settings_sms_log">
                                        <a href="<?= admin_url('shop_settings/sms_log') ?>">
                                            <i class="far fa-file-alt"></i><span class="text"> <?= lang('sms_log'); ?></span>
                                        </a>
                                    </li>
                                </ul>
                            </li>
