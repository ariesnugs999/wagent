    ...
    <div id="details" class="tab-pane fade in">
        ...
        <div class="box">
            <div class="box-header">
                <h2 class="blue"><i class="fa-fw far fa-file-alt nb"></i> <?= $product->name . (SHOP && $product->hide != 1 ? ' (' . lang('shop_views') . ': ' . $product->views . ')' : ''); ?></h2>
                            ...
                            <div class="btn-group btn-group-justified">
                                ...
                                <div class="btn-group">
                                    <a href="#" class="tip btn btn-danger bpo" title="<b><?= lang('delete_product') ?></b>"
                                        ...
                                        <i class="fas fa-trash-alt"></i> <span class="hidden-sm hidden-xs"><?= lang('delete') ?></span>
                                    </a>
                                </div>
                            </div>
                        </div>
