...
<div class="box">
                    ...
                    <ul class="dropdown-menu pull-right" class="tasks-menus" role="menu" aria-labelledby="dLabel">
                        ...
                        <li>
                            <a href="#" class="bpo" title="<b><?= $this->lang->line('delete_quotes') ?></b>" 
                                ...
                                data-html="true" data-placement="left"><i class="fas fa-trash-alt"></i> <?= lang('delete_quotes') ?>
                            </a>
                        </li>
                    </ul>
                </li>
    ...
    ?>
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu pull-right" class="tasks-menus" role="menu" aria-labelledby="dLabel">
                            <li><a href="<?= admin_url('quotes') ?>"><i class="far fa-building"></i> <?= lang('all_warehouses') ?></a></li>
                            <li class="divider"></li>
                            <?php
